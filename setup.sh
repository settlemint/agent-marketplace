...
force_update_plugin "semgrep-rule-creator@trailofbits" "semgrep-rule-creator (custom rules)"
...
force_update_plugin "fix-review@trailofbits" "fix-review (audit finding verification)"
force_update_plugin "variant-analysis@trailofbits" "variant-analysis (similar vulnerabilities)"
force_update_plugin "ask-questions-if-underspecified@trailofbits" "ask-questions-if-underspecified (requirements)"
force_update_plugin "dwarf-expert@trailofbits" "dwarf-expert (DWARF debugging)"
force_update_plugin "burpsuite-project-parser@trailofbits" "burpsuite-project-parser (Burp data)"
echo ""
