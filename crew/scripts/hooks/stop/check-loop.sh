...
# Re-feed the prompt (BLOCK exit by outputting continuation) - condensed output
echo ""
echo "═══════════════════════════════════════════════════════════"
...
echo "TASK: $PROMPT"
echo ""
echo "Run /compact, then continue. When done: <promise>$COMPLETION_PROMISE</promise>"
echo "Cancel: \`/crew:cancel-loop\`"
echo ""
