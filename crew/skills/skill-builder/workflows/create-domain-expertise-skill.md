...
AskUserQuestion:
  ...
  options:
    - label: "Build new {thing}"
      description: "Create a new {thing} from scratch"
    - label: "Debug {thing}"
      description: "Fix issues with an existing {thing}"
    - label: "Add feature"
      description: "Extend functionality of existing {thing}"
    - label: "Write tests"
