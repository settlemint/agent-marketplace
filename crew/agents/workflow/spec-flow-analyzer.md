...
description: Use this agent when you have a specification, plan, feature description, or technical document that needs user flow analysis and gap identification. This agent should be used proactively when analyzing feature specifications to identify all user flows, edge cases, and missing clarifications.
skills: frontend, api
model: inherit
---
