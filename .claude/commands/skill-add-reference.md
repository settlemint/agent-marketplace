---
description: Add a reference document to an existing skill (project)
...
Read and follow the workflow in `devtools/skills/skill-builder/workflows/add-reference.md`.
